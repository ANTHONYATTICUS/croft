          ...
          <div className={classes.container}>
            <GridContainer>
              <GridItem xs={12} sm={6} md={6}>
                ...
                <h4>
                During World War II, millions of Americans planted "victory gardens" in their backyards, 
                eventually supplying a hungry nation with 40 percent of its homegrown fruits and vegetables. 
                Once the war was over, those urban farms withered away, supplanted by increasingly efficient 

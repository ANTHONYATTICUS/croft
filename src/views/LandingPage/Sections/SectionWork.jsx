      ...
      <div className={classes.section}>
        <GridContainer justify="center">
          <GridItem cs={12} sm={8} md={8}>
            <h2 className={classes.title}>Working Together</h2>
            <h4 className={classes.description}>
            Write a few lines about your company or product and how we can
              collaborate. We will responde get back to you in a couple of
              hours.
            </h4>
            <form>
              <GridContainer>
